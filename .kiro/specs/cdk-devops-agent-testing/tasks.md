...
- [ ] 2. メインStack実装（障害パターン含む）
  ...
  - [ ] 2.2 CloudFrontディストリビューションと障害パターン（FP-CF-001〜003）を実装する
  ...
  - [ ] 2.3 VPC・SecurityGroup・EC2インスタンスと障害パターン（FP-EC2-001〜005）を実装する
    - VPCを`maxAzs: 2`で作成する
...
- [ ] 4. テストの実装
  ...
  - [ ] 4.3 CloudFront障害パターンのAssertionテスト（FP-CF-001〜003）を作成する
  ...
  - [ ] 4.4 EC2障害パターンのAssertionテスト（FP-EC2-001〜005）を作成する
...
- [ ] 6. CI/CDパイプラインの実装
  - [ ] 6.1 GitHub Actions workflowファイルを作成する
